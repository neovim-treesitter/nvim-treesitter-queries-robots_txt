# nvim-treesitter-queries-robots_txt

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-robots_txt/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-robots_txt/actions/workflows/validate.yml)

Neovim tree-sitter queries for **robots_txt**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-robots_txt",
...
- [ ] Changes are scoped to `robots_txt` — do not include files for other languages
